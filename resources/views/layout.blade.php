...
<body>
    <header>
        <video autoplay loop muted plays-inline class="back-video">
            <source src="videos/pexels-pressmaster-3130182-3840x2160-30fps.mp4" type="video/mp4">
        </video>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('app.certifs') }}">Boutique</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('app.partenaire') }}">Devenir Partenaire</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('app.contactez') }}">Contact</a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('app.auth') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
        ...
        <div class="content">
            <h1 class="title">CERTIFIER VOS COMPÉTENCES</h1>
            <p class="sub-title">Investir dans votre formation professionnelle, c'est investir dans votre avenir et
                votre carrière</p>
        </div>
