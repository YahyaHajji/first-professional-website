            ...
            <div class="container-fluid">
                <div class="d-flex align-items-center">
                    <div class="logo me-auto">
                        <img src="images/Logo-ATESMA.png" alt="atesma logo">
                    </div>
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" role="button" aria-expanded="false">Nos
                                Certifications</a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ route('app.microsoft') }}">Microsoft Office
                                        Specialist</a></li>
                                <li><a class="dropdown-item" href="{{ route('app.adobe') }}">Adobe Certified
                                        Professional</a></li>
                                <li><a class="dropdown-item" href="{{ route('app.autodesk') }}">Autodesk Certified User
                                        (ACU)</a></li>
                                <li><a class="dropdown-item" href="{{ route('app.its') }}">Information Technology
                                        Specialist</a></li>
                                ...
                                <li><a class="dropdown-item" href="{{ route('app.esb') }}">Entrepreneurship and Small
                                        Business
                                        (ESB)</a></li>
                                <li><a class="dropdown-item" href="#">Microsoft Certified Educator (MCE)</a></li>
                                <li><a class="dropdown-item" href="{{ route('app.csb') }}">Communication Skills for
                                        Business (CSB)</a>
                                </li>
                                <li><a class="dropdown-item" href="{{ route('app.ec-council') }}">EC-Council Associate
                                        (ECA)</a></li>
                                <li><a class="dropdown-item" href="{{ route('app.pmi') }}">Project Management Institute
                                        (PMI)</a></li>
                                <li><a class="dropdown-item" href="{{ route('app.unity') }}">Unity Certified User
                                        (UCU)</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item search">
                            <form action="{{ route('app.certifs') }}" method="POST">
                                ...
                                @method('GET')
                                <span class="icon">
                                    <a class="nav-link searchButton" href="#" style="display: inline;">
        ...
        <div class="Fcontainer">
            <div class="Row">
                <div class="footer-col">
                    <h4>Contact Us</h4>
                    <div class="contact">
                        <img src="images/Logo-ATESMA.png" alt="logo atesma">
